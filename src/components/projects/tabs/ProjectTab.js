    ...
    return (
        <Box sx={{ width: '100%' }} className="!mt-3">
            ...
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                <Tabs value={value} onChange={handleChange} aria-label="project tabs" className="dark-purple-bg card-tabs p-2 mb-3 !border grey-border border-solid rounded-md">
                    {/* KYC Tab */}
            ...
            {/* KYC Tab Panel */}
            <CustomTabPanel className="border card-verified-member mt-0 mb-3 rounded-md grey-border dark-purple-bg" value={value} index={0}>
            ...
            {/* Certificate Modal */}
            {modalOpen && <CertificateModal img={project.kycCertificate} buttonText="" open={modalOpen} setOpen={setModalOpen} />}
        </Box>
    );
}
